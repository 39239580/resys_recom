...
# csv 中  use_id   label + numeric_features +single_feature +multi_feature +
# features
...
#  所有发射次数， 最后发射， 所有视频数量，最后视频， 所有视频天数， 所有动作数量，最后动作，所有动作天数， 注册天

single_features = ['register_type', 'device_type']   # 单值特征2个  设备类型，注册类型
multi_features = ["multi"]  # ["multi"]  # 多值型
